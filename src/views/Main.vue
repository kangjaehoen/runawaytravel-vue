<template>
    ...
    <div>
        ...
        <div class="stretchedContainer">
            ...
            <AccCardStretched :accom="stretchedaccom[stretchedpage]" @click="goDetailPage(stretchedaccom[stretchedpage])" @stretchedbutton="movestrechedaccom"></AccCardStretched>
            </div>
        </div>
